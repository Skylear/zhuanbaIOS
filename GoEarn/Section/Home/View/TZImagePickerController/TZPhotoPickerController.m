...
- (void)configBottomToolBar {
    ...
    UIView *divide2 = [[UIView alloc] init];
    divide2.backgroundColor = [UIColor colorWithRed:rgb2 green:rgb2 blue:rgb2 alpha:1.0];
    divide2.frame = CGRectMake(0, 43.5, self.view.tz_width, 1);
    [self.navigationController.navigationBar addSubview:divide2];
...
- (UIBarButtonItem *)backItem{
    if (!_backItem) {        
        ...
        _backItem = [[UIBarButtonItem alloc] initWithCustomView:back_btn];
    }
    return _backItem;
}
-(void)back
