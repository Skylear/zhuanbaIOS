...
@property (nonatomic,strong) NSString * scrolOffsetY;
@end
...
//定义关联的Key
static const char * scrolOffsetYKey ;
- (NSString*)scrolOffsetY{
    
    return objc_getAssociatedObject(self, &scrolOffsetYKey);
}

- (void)setScrolOffsetY:(NSString*)scrolOffsetY{
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary<NSString *,id> *)change context:(void *)context{
    ...
    CGFloat offsetY = ([self doDeviceVersion] <= 5) ? [UIScreen mainScreen].bounds.size.height:[self.scrolOffsetY floatValue];
