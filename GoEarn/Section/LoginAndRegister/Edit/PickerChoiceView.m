...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        [self.cancelBtn setTitleColor:UIColorFromRGB(0x444444) forState:UIControlStateNormal];
        //完成
        ...
        [self.conpleteBtn setTitleColor:UIColorFromRGB(0x444444) forState:UIControlStateNormal];
...
- (void)creatDate{
    ...
    for (int i = 1; i < 13; i ++) {
        ...
        [monthArray addObject:[NSString stringWithFormat:@"%02d月",i]];
        if (i==2) {
            for (int i = 1; i < 30; i ++) {
                
                [daysArray addObject:[NSString stringWithFormat:@"%02d日",i]];
            }
