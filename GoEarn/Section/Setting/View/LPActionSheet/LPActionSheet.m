...
{
    return [self initWithTitle:nil cancelButtonTitle:nil destructiveButtonTitle:nil otherButtonTitles:nil isShow:nil handler:nil];
//    return [self initWithTitle:nil cancelButtonTitle:nil destructiveButtonTitle:nil otherButtonTitles:nil isShow:nil handler:nil];
}
...
- (instancetype)initWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelButtonTitle destructiveButtonTitle:(NSString *)destructiveButtonTitle otherButtonTitles:(NSArray *)otherButtonTitles  isShow:(BOOL)isShow handler:(LPActionSheetBlock)actionSheetBlock
{
...
//选择性别标记
                ...
                choiceBtn.frame = CGRectMake(SCREEN_WIDTH-40, (kRowHeight-20)/2, 20, 20);
                choiceBtn.hidden = _isShow;
//                [choiceBtn setImage:[UIImage imageNamed:@"huhiu"] forState:UIControlStateNormal];
                [choiceBtn setImage:[UIImage imageNamed:@"huhiu"] forState:UIControlStateSelected];
                [choiceBtn addTarget:self action:@selector(buttonClicked:) forControlEvents:UIControlEventTouchUpInside];
                [button addSubview:choiceBtn];
            }
        }
...
+ (instancetype)actionSheetWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelButtonTitle destructiveButtonTitle:(NSString *)destructiveButtonTitle otherButtonTitles:(NSArray *)otherButtonTitles isShow:(BOOL)isShow handler:(LPActionSheetBlock)actionSheetBlock
{
//    return [[self alloc] initWithTitle:title cancelButtonTitle:cancelButtonTitle destructiveButtonTitle:destructiveButtonTitle otherButtonTitles:otherButtonTitles handler:actionSheetBlock];
    return [[self alloc] initWithTitle:title cancelButtonTitle:cancelButtonTitle destructiveButtonTitle:destructiveButtonTitle otherButtonTitles:otherButtonTitles isShow:isShow handler:actionSheetBlock];
}

+ (void)showActionSheetWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelButtonTitle destructiveButtonTitle:(NSString *)destructiveButtonTitle otherButtonTitles:(NSArray *)otherButtonTitles isShow:(BOOL)isShow handler:(LPActionSheetBlock)actionSheetBlock
{
    
    LPActionSheet *lpActionSheet = [self actionSheetWithTitle:title cancelButtonTitle:cancelButtonTitle destructiveButtonTitle:destructiveButtonTitle otherButtonTitles:otherButtonTitles isShow:isShow handler:actionSheetBlock];
    [lpActionSheet show];
}
